...
<title>BOARD ADD FORM(spring mvc 방식)</title>
</head>
<body>
<div class="container">
    <h1>BOARD ADD FORM(spring mvc 방식)</h1> 
    <form id="modifyForm" action="${pageContext.request.contextPath}/addBoard" method="post"
        ...
        <div class="form-group">boardUser :
            <textarea class="form-control" id="boardUser" name="boardUser" rows="5" cols="50">${board.boardContent}</textarea>
        </div>
        ...
        <div>
            <input class="btn btn-default" id="modifyButton" type="submit" value="글작성"/>
